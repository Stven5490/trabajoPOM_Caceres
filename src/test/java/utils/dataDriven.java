...
public class dataDriven {
    public static ArrayList<String> getTestData(String nombreCP) {
        ...
        try {
            file = new FileInputStream(System.getProperty("user.dir")+propertiesDriven.obtenerProperties("rutaExcel"));
        ...
        for(int i = 0; i< sheets;i++){
            if(excel.getSheetName(i).equalsIgnoreCase(propertiesDriven.obtenerProperties("hojaDataExcel"))){
                ...
                while(celdas.hasNext()){
                    ...
                    if(celdaSelecciona.getStringCellValue().equalsIgnoreCase(propertiesDriven.obtenerProperties("TituloCPS"))){
                        columna = k;
                    }
                    k++;
                }
